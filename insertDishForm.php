		...
		<div id="wrapper">
			<main>
				...
				<?php
					...
					$Des_dishErr = $Name_dishErr =$Id_dishErr=$Menu_codeErr ="";
					$Des_dish = $Name_dish = $Id_dish=$Menu_code ="";
					...
					<form style="color:blue;font-family : arial;" method="post" action="insertDish.php"<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>>
